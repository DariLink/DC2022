...
data = pd.read_sql("select text as comment_text from text_all where sentiment_final = -1 and ;", connection,
                   index_col=None)
...
data['comment_text_clean'] = data.comment_text_clean.apply(
